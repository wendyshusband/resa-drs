...
import resa.shedding.ExampleShedder;
import resa.shedding.RandomSheddableBolt;
 ...
 * capabilities.
 */
public class SheddingSimExpServWC2Path {
    ...
    public static void main(String[] args) throws Exception {
        ...
        builder.setBolt("2Path-BoltC", new outputBolt(),
                ConfigUtil.getInt(conf, "2Path-BoltC.parallelism", 1))
                .setNumTasks(defaultTaskNum)
                .shuffleGrouping("2Path-BoltB");
        ...
        StormSubmitter.submitTopology("qw-shedding-2Path", conf, builder.createTopology());
    }
}
