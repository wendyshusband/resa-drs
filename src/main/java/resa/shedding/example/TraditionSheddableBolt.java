...
public class TraditionSheddableBolt extends DelegatedBolt implements IShedding{
    ...
    public TraditionSheddableBolt() {
    }
    public TraditionSheddableBolt(IRichBolt bolt){
        super(bolt);
    }
    ...
    public void prepare(Map stormConf, TopologyContext context, OutputCollector outputCollector) {
        ...
        LOG.info("Preparing TraditionSheddableBolt: " + context.getThisComponentId());
    }
    ...
    public int passiveDrop(Object[] arg) {
        ...
        shedTupleNum = (int) (tupleNums - tupleQueueCapacity * passiveSheddingLowThreshold);
        System.out.println(tupleNums+"~"+"traditional sheddTuple: "+shedTupleNum);
    ...
    public boolean trigger(Object[] arg) {
        return (pendingTupleQueue.size() >= (passiveSheddingHighThreshold * tupleQueueCapacity));
    }
